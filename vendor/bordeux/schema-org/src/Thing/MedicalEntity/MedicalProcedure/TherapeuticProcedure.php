 ...
 *
 * @method TherapeuticProcedure setContraindication(\Bordeux\SchemaOrg\Thing\MedicalEntity\MedicalContraindication $contraindication ) setContraindication(\Bordeux\SchemaOrg\Thing\MedicalEntity\MedicalContraindication[] $contraindication )A contraindication for this therapy.
 *
 *
 * -------------------------------- DuplicateTherapy ---------------------------------------------
 *
 ...
 *
 * @method TherapeuticProcedure setDuplicateTherapy(\Bordeux\SchemaOrg\Thing\MedicalEntity\MedicalTherapy $duplicateTherapy ) setDuplicateTherapy(\Bordeux\SchemaOrg\Thing\MedicalEntity\MedicalTherapy[] $duplicateTherapy )A therapy that duplicates or overlaps this one.
 *
 *
 * -------------------------------- Indication ---------------------------------------------
 *
 ...
 *
 * @method TherapeuticProcedure setIndication(\Bordeux\SchemaOrg\Thing\MedicalEntity\MedicalIndication $indication ) setIndication(\Bordeux\SchemaOrg\Thing\MedicalEntity\MedicalIndication[] $indication )A factor that indicates use of this therapy for treatment and/or prevention of a condition, symptom, etc. For therapies such as drugs, indications can include both officially-approved indications as well as off-label uses. These can be distinguished by using the ApprovedIndication subtype of MedicalIndication.
 *
 *
 ...
 *
 * @method TherapeuticProcedure setSeriousAdverseOutcome(\Bordeux\SchemaOrg\Thing\MedicalEntity $seriousAdverseOutcome ) setSeriousAdverseOutcome(\Bordeux\SchemaOrg\Thing\MedicalEntity[] $seriousAdverseOutcome )A possible serious complication and/or serious side effect of this therapy. Serious adverse outcomes include those that are life-threatening; result in death, disability, or permanent damage; require hospitalization or prolong existing hospitalization; cause congenital anomalies or birth defects; or jeopardize the patient and may require medical or surgical intervention to prevent one of the outcomes in this definition.
 *
 *
 */
 class TherapeuticProcedure extends \Bordeux\SchemaOrg\Thing\MedicalEntity\MedicalProcedure {
